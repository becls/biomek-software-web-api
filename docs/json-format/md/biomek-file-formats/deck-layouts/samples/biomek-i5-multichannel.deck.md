# Deck Layout: Biomek i5 Multichannel
...
- Duplicate-deck note: this configuration also exposes a `Standard` deck whose positions, coordinates, groups, and characteristics are byte-identical to this `Multichannel` deck (only `deckName` differs). No separate view is kept for it — this file is authoritative for both.
...
10   [empty]   [WS1]     [TL1]     [P1]      [P6]      [P11]     [empty]
15   [TR1              ] [TL2]     [P2]      [P7]      [P12]     [empty]
20   [empty]   [empty]   [TL3]     [P3]      [P8]      [P13]     [empty]
25   [empty]   [empty]   [TL4]     [P4]      [P9]      [P14]     [empty]
30   [empty]   [empty]   [TL5]     [P5]      [P10]     [P15]     [empty]
```
